...
const conv1 = {
  ...
  messages: [
    ...
    { id: "msg_1_10", text: "What's the float charge for? $450 seems like a lot for something I didn't ask for.", timestamp: ts(-6 * HOUR), isFromCustomer: true, type: "text" },
  ],
  lastMessage: { text: "What's the float charge for? $450 seems like a lot for something I didn't ask for.", timestamp: ts(-6 * HOUR), isFromCustomer: true },
  unreadCount: 1,
  hasAIAction: true,
...
const conv2 = {
  ...
  messages: [
    ...
    { id: "msg_2_7", text: "All done Patricia! The floors turned out beautiful. The Provincial stain really brought out the grain. Remember, no shoes on them for 48 hours and avoid rugs for a week while the finish fully cures.", timestamp: ts(-10 * HOUR), isFromCustomer: false, type: "text" },
    { id: "msg_2_8", text: "They look beautiful! I can't believe these are the same floors.", timestamp: ts(-9.5 * HOUR), isFromCustomer: true, type: "text" },
    { id: "msg_2_9", text: "Invoice #1002 for $2,800.00 has been sent.", timestamp: ts(-9 * HOUR), isFromCustomer: false, type: "invoice" },
    { id: "msg_2_10", text: "Got it, I'll take a look!", timestamp: ts(-8 * HOUR), isFromCustomer: true, type: "text" },
  ],
  lastMessage: { text: "Got it, I'll take a look!", timestamp: ts(-8 * HOUR), isFromCustomer: true },
  unreadCount: 0,
  hasAIAction: true,
...
const conv3 = {
  ...
  messages: [
    ...
    { id: "msg_3_6", text: "Hey Sandro, are we still on for tomorrow morning?", timestamp: ts(-45 * 60 * 1000), isFromCustomer: true, type: "text" },
  ],
  lastMessage: { text: "Hey Sandro, are we still on for tomorrow morning?", timestamp: ts(-45 * 60 * 1000), isFromCustomer: true },
  unreadCount: 1,
  hasAIAction: false,
  actionType: null,
};
...
const conv4 = {
  ...
  messages: [
    ...
    { id: "msg_4_9", text: "Hey Sandro! Quick question — how long before I can put area rugs on the new LVP?", timestamp: ts(-2 * HOUR), isFromCustomer: true, type: "text" },
  ],
  lastMessage: { text: "Hey Sandro! Quick question — how long before I can put area rugs on the new LVP?", timestamp: ts(-2 * HOUR), isFromCustomer: true },
  unreadCount: 1,
  hasAIAction: false,
  actionType: null,
};
...
const conv6 = {
  ...
  messages: [
    ...
    { id: "msg_6_5", text: "Also, do you have any samples I could see when you come by? I'm torn between two colors.", timestamp: ts(-15 * 60 * 1000), isFromCustomer: true, type: "text" },
  ],
  lastMessage: { text: "Also, do you have any samples I could see when you come by? I'm torn between two colors.", timestamp: ts(-15 * 60 * 1000), isFromCustomer: true },
  unreadCount: 1,
  hasAIAction: false,
  actionType: null,
};
